...
موفق و پرفروش باشید"""
        ...
        with col1:
            st.markdown(f'<a href="{store_url}" target="_blank"><button style="width:100%;background-color:#FF5A5F;color:white;padding:14px;border:none;border-radius:6px;font-size:16px;font-weight:bold;cursor:pointer;">🏪 باز کردن سایت باسلام</button></a>', unsafe_allow_html=True)
